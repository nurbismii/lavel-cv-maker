...
@section('title', 'Verifikasi Email - CV HRIS')
...
@section('content')
    <div class="auth-wrap">
        @include('partials.page-header', [
            ...
            'subtitle' => 'Kami sudah mengirim link verifikasi ke email yang Anda daftarkan. Klik link tersebut untuk mengaktifkan akses CV HRIS.',
        ])
