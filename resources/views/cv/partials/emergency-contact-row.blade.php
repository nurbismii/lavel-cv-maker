...
<div class="repeat-item repeat-item--compact" data-repeat-item>
    <div class="row g-3 align-items-end">
        <div class="col-md-3">
            <label class="form-label cv-required-label">Nomor Kontak Darurat <span class="required-indicator" aria-hidden="true">*</span><span class="visually-hidden"> wajib diisi</span></label>
        ...
        <div class="col-md-4">
            <label class="form-label cv-required-label">Nama Kontak Darurat <span class="required-indicator" aria-hidden="true">*</span><span class="visually-hidden"> wajib diisi</span></label>
        ...
        <div class="col-md-3">
            <label class="form-label cv-required-label">Hubungan <span class="required-indicator" aria-hidden="true">*</span><span class="visually-hidden"> wajib diisi</span></label>
