...
class InternalVPeopleCvController extends Controller
{
    private const PROFILE_COLUMNS = [
        ...
        'work_area', 'department', 'division', 'position', 'job_title', 'job_title_id',
        'organization_position_id', 'job_level_code', 'job_level_rank',
        'organization_updated_at', 'current_job_entry_date',
